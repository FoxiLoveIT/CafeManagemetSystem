...
public class BillDao {
    ...
    public static void save(Bill bill){
        String query = "insert into bill values ('"+bill.getId()+"','"+bill.getName()+"','" + bill.getMobileNumber()+"','"+ bill.getCard() +"','"+ bill.getDate()+"','"+bill.getTotal()+"','"+bill.getCreatedBy()+"')";
    ...
    public static ArrayList<Bill> getAllRecordsByDesc(String date){
      ...
      try{
        ...
        bill.setCard(rs.getString("card"));
